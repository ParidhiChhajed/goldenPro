      ...
      if(frameCount%120==0){
       ...
       if(keyCode === 32){
        ...
        if (index === player.index){
          ...
          fill("white")
          text("Player 1" + " : " + allPlayers.car1.score, displayWidth/2, displayHeight/2);
          text(player.name + ": " + allPlayers.car2.score, displayWidth/2, displayHeight/2);
          text(player.name + ": " + allPlayers.car3.score, displayWidth/2, displayHeight/2);
          text(player.name + ": " + allPlayers.car4.score, displayWidth/2, displayHeight/2);
